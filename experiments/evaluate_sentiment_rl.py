...
class SentimentRLEvaluator:
    ...
    def _run_annual_stable_comparison(self):
        ...
        - Sentiment RL (monthly, 192 steps) vs DP in VIX-adjusted market

        Uses inline annual Pure RL + DP implementation.
        Market shocks are derived consistently: annual = aggregated monthly.
        """
        start_time = time.time()
        ...
        logger.info("  Sentiment RL (monthly) vs DP in VIX market")
        logger.info("=" * 70)
